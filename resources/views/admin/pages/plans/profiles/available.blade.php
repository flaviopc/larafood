...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('plans.profiles.available',$plan->id) }}">Disponíveis</a></li>
</ol>
                ...
                <form action="{{ route('plans.profiles.attach',$plan->id)}}" method="POST">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <button type="submit" class="btn btn-success">Atribuir Perfis</button>
                        </td>
                    </tr>
                </form>
            </tbody>
